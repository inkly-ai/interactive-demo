  ...
  return (
    <div
      ...
      className={cn(
        ...
        variant === "lifted"
          ? "surface-lifted rounded-[16px] text-[color:var(--ink-strong)]"
          : variant === "flat"
          ? "rounded-[14px] border border-[color:var(--line)] bg-[color:var(--surface)] text-[color:var(--ink-strong)]"
